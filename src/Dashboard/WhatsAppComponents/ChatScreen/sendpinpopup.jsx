...
const SendPinPopup = ({ MediaUpload, senderNumber }) => {
  return (
          ...
          <div className="dropdown-item">
            <div className="d-flex flex-row align-items-center justify-content-between">
              <label
                ...
                onClick={() => MediaUpload("image", senderNumber)}>
              ...
              <label
                onClick={() => MediaUpload("document", senderNumber)}
                className="d-flex flex-column align-items-center cr-p">
              ...
              <label
                onClick={() => MediaUpload("audio", senderNumber)}
                className="d-flex flex-column align-items-center cr-p">
              ...
              <label
                onClick={() => MediaUpload("video", senderNumber)}
                className="d-flex flex-column align-items-center cr-p">
                <div className="attach-item attach-item3">
